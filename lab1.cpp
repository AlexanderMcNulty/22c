...
public:
        ...
        friend void operator - (Wallet &refWalletObject, double number)
        {
                //refWalletObject
        }
};
...
int main()
{
        ...
        while (choice != 5) {
                ...
                case 3: {  // report funds choice
                        ...
                        //double x2 = testDollars.getCurrentFundsValue();
                        mainWallet.listAllCurrencyValues();
...
void requestCurrencyNumberValues(bool isAddition, Wallet &walletReference, int currencyType)
{
        ...
        if (isAddition) { // if this is an addition request
                ...
                //dollarsPtr - value;
                //*walletReference.current_currencies[currencyType] - value;
        }
        //cout << "press Enter to continue ...";
        cin.get();
}
